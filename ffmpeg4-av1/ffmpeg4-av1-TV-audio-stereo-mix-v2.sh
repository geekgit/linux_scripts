...
do
	...
	/opt/$ffmpegOpt/bin/ffmpeg -y -i $File -vcodec copy -acodec aac -strict experimental -ab 320k -ac 2 -ar 48000 -af "pan=stereo|FL=FC+0.30*FL+0.30*BL|FR=FC+0.30*FR+0.30*BR" "$NewName"
